          ...
          <v-simple-table dense>
            ...
            <tbody>
              <tr v-for="user in users" :key="user.id">
                ...
                <td>{{ user.name }}</td>
                <td>
                  <v-icon small color="warning" class="ma-1">mdi-pencil</v-icon>
                  <v-icon small color="success" class="ma-1">mdi-key</v-icon>
                  <v-icon small color="error" class="ma-1">mdi-close</v-icon>
                </td>
              </tr>
            </tbody>
          </v-simple-table>
